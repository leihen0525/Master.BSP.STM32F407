...
typedef struct
{
	union
	{
		...
		struct
		{
			...
			__IO uint32_t DC				:1;
			__IO uint32_t BL				:2;
			__IO uint32_t APCS				:1;

			__IO uint32_t 					:1;
			__IO uint32_t RD				:1;
			__IO uint32_t IPCO				:1;
			__IO uint32_t DM				:1;
			__IO uint32_t LM				:1;
			__IO uint32_t ROD				:1;
			__IO uint32_t FES				:1;
	...
	union
	{
		...
		struct
		{
			...
			__IO uint32_t TFCE				:1;
			__IO uint32_t RFCE				:1;
			__IO uint32_t UPFD				:1;
			__IO uint32_t PLT				:2;
			__IO uint32_t 					:1;
			__IO uint32_t ZQPD				:1;
	...
	union
	{
		...
		struct
		{
			__IO uint32_t VLANTI			:16;

			__IO uint32_t VLANTC			:1;
			__IO uint32_t 					:15;
		}MACVLANTR_BIT;
	};
	...
	union
	{
		...
		struct
		{
			__IO uint32_t MAC_ADDR4				:8;

			__IO uint32_t MAC_ADDR5				:8;
	...
	union
	{
		...
		struct
		{
			__IO uint32_t MAC_ADDR0				:8;
			__IO uint32_t MAC_ADDR1				:8;
			__IO uint32_t MAC_ADDR2				:8;
			__IO uint32_t MAC_ADDR3				:8;
		}MACA0LR_BIT;
	};
	...
	union
	{
		...
		{
			__IO uint32_t TS				:1;
			__IO uint32_t TPSS				:1;
			__IO uint32_t TBUS				:1;
			__IO uint32_t TJTS				:1;
			__IO uint32_t ROS				:1;
			__IO uint32_t TUS				:1;
			__IO uint32_t RS				:1;
			__IO uint32_t RBUS				:1;

			__IO uint32_t RPSS				:1;
			__IO uint32_t RWTS				:1;
			__IO uint32_t ETS				:1;
			__IO uint32_t 					:2;
			__IO uint32_t FBES				:1;
			__IO uint32_t ERS				:1;
			__IO uint32_t AIS				:1;
			...
			__IO uint32_t EBS				:3;
			__IO uint32_t 					:1;
			__IO uint32_t MMCS				:1;
			__IO uint32_t PMTS				:1;
			__IO uint32_t TSTS				:1;
			__IO uint32_t 					:2;
		}DMASR_BIT;
	};
	union
	{
		...
		struct
		{
			...
			__IO uint32_t SR				:1;
			__IO uint32_t OSF				:1;
			__IO uint32_t RTC1				:2;
			__IO uint32_t 					:1;
			__IO uint32_t FUGF				:1;
			__IO uint32_t FEF				:1;
			...
			__IO uint32_t DFRF				:1;
			__IO uint32_t RSF				:1;
			__IO uint32_t DTCEFD			:1;
			__IO uint32_t 					:5;
		}DMAOMR_BIT;
	};
	union
	{
		...
		{
			__IO uint32_t TIE				:1;
			__IO uint32_t TPSIE				:1;
			__IO uint32_t TBUIE				:1;
			__IO uint32_t TJTIE				:1;
			__IO uint32_t ROIE				:1;
			__IO uint32_t TUIE				:1;
			__IO uint32_t RIE				:1;
			__IO uint32_t RBUIE				:1;

			__IO uint32_t RPSIE				:1;
			__IO uint32_t RWTIE				:1;
			__IO uint32_t ETIE				:1;
			__IO uint32_t 					:2;
			__IO uint32_t FBEIE				:1;
			__IO uint32_t ERIE				:1;
			__IO uint32_t AISE				:1;

			__IO uint32_t NISE				:1;
			__IO uint32_t 					:15;
...
typedef struct
{
	...
	union
	{
		...
		struct
		{
			...
			__IO uint32_t AFRL8					:4;
			__IO uint32_t AFRL9					:4;
			__IO uint32_t AFRL10				:4;
			__IO uint32_t AFRL11				:4;
			__IO uint32_t AFRL12				:4;
			__IO uint32_t AFRL13				:4;
			__IO uint32_t AFRL14				:4;
			__IO uint32_t AFRL15				:4;
		}AFR_BIT;
	};
} GPIO_TypeDef;
...
typedef struct
{
	...
	union
	{
		...
		struct
		{
			__IO uint16_t DIV_Fraction		:4;
			__IO uint16_t DIV_Mantissa		:12;
	...
	union
	{
		...
		struct
		{
			...
			__IO uint16_t RE				:1;
			__IO uint16_t TE				:1;
			__IO uint16_t IDLEIE			:1;
			__IO uint16_t RXNEIE			:1;
			__IO uint16_t TCIE				:1;
			__IO uint16_t TXEIE				:1;

			__IO uint16_t PEIE				:1;
			__IO uint16_t PS				:1;
			__IO uint16_t PCE				:1;
			__IO uint16_t WAKE				:1;
			__IO uint16_t M					:1;
			__IO uint16_t UE				:1;
			__IO uint16_t					:1;
			__IO uint16_t OVER8				:1;
		}CR1_BIT;
	};
